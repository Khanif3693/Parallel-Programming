...

{
	...
	{
	fprintf(stderr," Please enter the number for scheduling type as follows:\n ");
	fprintf(stderr,"1:COARSE_DYNAMIC \n 2:COARSE_STATIC \n 3:FINE_DYNAMIC \n 4:FINE_STATIC");
	fprintf(stderr,"\nAlso enter the number of threads.\n");
	fprintf(stderr,"To execute file: filename \t schedule type \t thread number ");
	}
		...
		if (TYPE == 1)
		{
		 ...
		 printf("Time is %10.2lf,\n",1000000.*(time1-time0));
		 printf("For the COARSE_DYNAMIC\n");
		 printf("Performance: %10.2lf\n",((float)(NUMBODIES*NUMBODIES*NUMSTEPS)/(time1-time0)/1000000.));
		}
		else if (TYPE == 2)
		{
         for( int t = 0; t < NUMSTEPS; t++ )
		 ...
		 printf("Number of Threads: %d,\n",NUMTHREADS);
		 printf("Time is : %10.2lf,\n",1000000.*(time1-time0));
		 printf("for the COARSE_STATIC\n");
		 printf("Perfromance :%10.2lf\n",((float)(NUMBODIES*NUMBODIES*NUMSTEPS)/(time1-time0)/1000000.));
		}
		else if (TYPE==3)
		{
         for( int t = 0; t < NUMSTEPS; t++ )
		...
		else if(TYPE==4)
		{
		 ...
		 printf("Number of threads: %d,\n",NUMTHREADS);
		 printf("Time is :%10.2lf,\n",1000000.*(time1-time0));
		 printf("Type is FINE_DYNAMIC");
		 printf("performance :%10.2lf\n",((float)(NUMBODIES*NUMBODIES*NUMSTEPS)/(time1-time0)/1000000.));
		}
		else 
		{
			fprintf(stderr,"entered number should be between 1 to 4");
		}
